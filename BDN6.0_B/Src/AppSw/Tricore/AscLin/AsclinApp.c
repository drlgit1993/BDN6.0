...
void bsp_UART1_init(void)
{
    ...
    IfxAsclin_Asc_Config UART1_Config;   //定义一个ascConfig的结构体，用于表示asc设置
    IfxAsclin_Asc_initModuleConfig(&UART1_Config, &MODULE_ASCLIN1); //用内置的ASCLIN1来初始化刚刚定义的asc结构体
...
void bsp_UART2_init(void)
{
    ...
    /* create module config */
    IfxAsclin_Asc_Config UART2_Config;   //定义一个ascConfig的结构体，用于表示asc设置
    IfxAsclin_Asc_initModuleConfig(&UART2_Config, &MODULE_ASCLIN2); //用内置的ASCLIN1来初始化刚刚定义的asc结构体
...
void bsp_UART3_init(void)
{
    ...
    /* create module config */
    IfxAsclin_Asc_Config UART3_Config;   //定义一个ascConfig的结构体，用于表示asc设置
    IfxAsclin_Asc_initModuleConfig(&UART3_Config, &MODULE_ASCLIN3); //用内置的ASCLIN1来初始化刚刚定义的asc结构体
